...
FLOWABLE.APP_URL = {
    ...
    getFlowOption: function (key) {
        return FLOWABLE.CONFIG.hr + '/modeler/get-flow-select?key=' + key;
    },


    getRoleUrl: function () {
        return FLOWABLE.CONFIG.hr + '/role/flowable-all';
    },

    getUserUrl: function () {
        return FLOWABLE.CONFIG.hr + '/sysUser/flowable-all';
    },

    /* ACCOUNT URLS */

    getAccountUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/hr/rest/account';
    },
    ...
    getModelBpmn20ExportUrl: function (modelId) {
        return FLOWABLE.CONFIG.contextRoot + '/hr/rest/models/' + modelId + '/bpmn20?version=' + Date.now();
    },
    ...
    getModelHistoryUrl: function (modelId, modelHistoryId) {
        return FLOWABLE.CONFIG.contextRoot + '/hr/rest/models/' + modelId + '/history/' + modelHistoryId;
    },
    ...
    getImportProcessModelUrl: function () {
        return FLOWABLE.CONFIG.contextRoot + '/hr/rest/import-process-model';
    },
